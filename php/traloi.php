...
<body>
  ...
  <div id="menu1">
    ...
    <div id="wrapper"> 
    	<div class="content">
		<div class="luuy"><b>LƯU Ý : Sau khi trả lời, tin nhắn sẽ tự động bị xóa trong hộp thư đến.</b></div>
        <?php
$a = $_GET["sdt"];
if($a == 1){
	$sdt = $_COOKIE["user1"];
...
if($sub == "gui"){
	if(!$area){
			...
			//THuc hien lenh xoa sms den
			unlink("sms/noidung/".$txt.".txt");
